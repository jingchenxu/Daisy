...
import org.deepwater.daisy.entity.user.UserExample.Criteria;
import org.deepwater.daisy.entity.user.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String countByExample(UserExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("T_DAISY_USER");
    ...
    public String insertSelective(User record) {
        ...
        if (record.getUserCreatedata() != null) {
            sql.VALUES("user_createdata", "#{userCreatedata,jdbcType=DATE}");
        }
        
        if (record.getUserAvator() != null) {
            sql.VALUES("user_avator", "#{userAvator,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getUserCreatedata() != null) {
            sql.SET("user_createdata = #{userCreatedata,jdbcType=DATE}");
        }
        
        if (record.getUserAvator() != null) {
            sql.SET("user_avator = #{userAvator,jdbcType=VARCHAR}");
        }
