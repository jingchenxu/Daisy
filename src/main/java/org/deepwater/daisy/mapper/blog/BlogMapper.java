...
public interface BlogMapper {
    ...
    @Insert({
            ...
            "#{blogAuthor,jdbcType=VARCHAR}, #{blogPublishtime,jdbcType=TIMESTAMP}, ",
    ...
    @Results({
            ...
            @Result(column="blog_publishtime", property="blogPublishtime", jdbcType=JdbcType.TIMESTAMP),
    ...
    @Update({
            ...
            "blog_publishtime = #{blogPublishtime,jdbcType=TIMESTAMP},",
